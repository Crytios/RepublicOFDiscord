...
class Currency(commands.Cog):
  ...
  @commands.command(breif="Daily ClydeCoin Usage - +daily")
  ...
  @commands.command(brief="Daily Vip ClydeCoins usage- +vip") 
  @commands.cooldown(1, 86400, BucketType.user)
  async def vip(self,ctx):
    guild = ctx.message.guild
    role1 = ctx.guild.get_role(848929092731797514)
    #role_names = [role1.name for role in ctx.author.roles]
    print("hi")
    role_names  = [
    ]
  ...
  @commands.command(brief="Check Balance usage-+bal @member or +bal")
  ...
  @commands.command(brief="Add ClydeCouns usage- +addBal <value> @member")  
  ...
  @commands.command(brief="Subtract ClydeCouns usage- +subBal <value> @membed")  
  @commands.has_permissions(kick_members=True)  
